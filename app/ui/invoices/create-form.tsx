  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        {/* Invoice Amount - ADDED ARIA AND ERROR BLOCK */}
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                aria-describedby="amount-error" // <--- ADDED THIS
              />
        ...
        {/* Invoice Status - ADDED ARIA AND ERROR BLOCK */}
        <fieldset aria-describedby="status-error"> {/* <--- ADD THIS */}
